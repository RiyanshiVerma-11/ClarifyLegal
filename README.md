...
graph TB
    ...
    subgraph ServerContainer [Full-Stack Node.js Container : Port 3000]
        ...
        ExpressServer --> FallbackEngine
        ExpressServer --> GenAISDK
        WSServer --> GenAISDK
    end
...
stateDiagram-v2
    ...
    DispatchAPI --> SimulationEngine
    SimulationEngine --> RenderResults: Structured CounterpartySimulationResult
...
graph TD
    ...
    MainContent --> Analyzer
    MainContent --> LiveVoice
    MainContent --> Chatbot
    MainContent --> Compare
    MainContent --> Playbook
    MainContent --> Decoder
